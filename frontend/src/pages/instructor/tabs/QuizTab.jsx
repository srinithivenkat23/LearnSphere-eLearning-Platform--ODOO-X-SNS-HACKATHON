    ...
    return (
        <div className="p-8 animate-fade-in relative h-full flex flex-col">
            <div className="flex justify-between items-center mb-10 pb-6 border-b border-slate-50">
                ...
                <Button
                    onClick={() => navigate(`/instructor/courses/${course.id}/quiz/new`)}
            ...
            <div className="flex-1 space-y-4">
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {quizzes.map((quiz) => (
                            <div key={quiz.id} className="group bg-white border border-slate-100 p-6 rounded-2xl hover:border-indigo-200 hover:shadow-xl hover:shadow-indigo-500/5 transition-all">
                                <div className="flex items-start justify-between mb-4">
                                    ...
                                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button
                                            onClick={() => navigate(`/instructor/courses/${course.id}/quiz/${quiz.id}`)}
